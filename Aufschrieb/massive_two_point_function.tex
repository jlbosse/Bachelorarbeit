...
\todo[color=red]{Wie gehe ich mit der falschen Fouriertransformierten für $\Delta$ um?}
...
Offensichtlich ist $\hat\Delta_m \subset C^{(3)}$, d.h. der entscheidende Beitrag der Shearlettransformation ist
\begin{equation*}
