...
\todo[color=red]{Ich will temperierte Distributionen anschauen, nicht beschränkte Funktionen! Brauche also eigentlich ein anderes Lemma mit einem anderen Beweis}
\begin{lemma}
\label{lemm:lemma54}
...
\begin{figure}[h]
\centering
\input{images/smart_decomposition.pgf}
