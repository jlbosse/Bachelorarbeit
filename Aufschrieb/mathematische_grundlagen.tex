...
Sei $f \in \mathcal{E}'(\Omega), \Omega \subset \mathbb{R}^n$ ein kompakt getragene Distribution. Dann definieren wir die Richtungen höher Frequenzen als
\begin{dmath*}
...
Aber weshalb ist die Wellenfrontmenge interessant für uns? Eine der Antworten ist, dass sie uns ein Kriterium liefert, wann das Produkt zweier Distributionen wohl definiert ist. Und zwar mittels folgendem Satz:

\begin{theorem}[Hörmanders Kriterium]
\label{thm:hoermanders_criterion}
    Seien $f,g \in \mathcal{D}(\Omega), ~\Omega \subset \mathbb{R}^n$ Distributionen und es gelte $(x,k) \in WF(f) \Rightarrow (x,-k) \notin WF(g)$. Es sei außerdem $\delta : \Omega \rightarrow \Omega \times \Omega; x \mapsto (x,x)$. Dann kann das Produkt von $f$ und $g$ definiert werden über den Pullpack mit $\delta$, also
    \begin{equation*}
...
\end{equation*}
für alle $k$ existiert. "`Schnell genug"' ist aber nicht nur exponentieller Abfall, sondern sogar schon $o(k^{\prime -n})$.
