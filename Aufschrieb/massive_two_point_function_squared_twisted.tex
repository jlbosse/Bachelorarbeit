...
Bevor wir uns aber der Wellenfrontmenge widmen können, brauchen wir einen Ausdruck für die Fouriertransformierte $\rwhat{\Delta}_m^{\ast_\Omega 2}$ von $\Delta_m^{\star 2}$.
...
\begin{figure}
    ...
    \begin{minipage}{0.55\textwidth}
        ...
        \caption{Plot von $\hat\Delta_m^{\ast_\Omega 2}$ und $\hat\Delta_m$. Wieder liegt der Träger von $\hat\Delta_m^{\ast_\Omega 2}$ in der kausalen Zukunft.
        }
    ...
    \begin{minipage}{0.45\textwidth}
        ...
        \caption{Plot von $\left.\hat{\Delta}_m^{\ast_\Omega 2}\right|_{k=0}$ um das asymptotische Verhalten für $\omega \rightarrow 0$ und $\omega \rightarrow \infty$ zu verdeutlichen}
...
\begin{equation}
    \left\langle \rwhat{\Delta}_m^{\ast_\Omega 2}, \hat\psi_{ast}\right\rangle
...
\begin{dmath}
    \left\langle \rwhat{\Delta}_m^{\ast_\Omega 2}, \rwhat{\psi}_{ast}
    \right\rangle
    =
...
\begin{align}
    & \kern -2em\left\langle \rwhat{\Delta}_m^{\ast_\Omega 2}, \rwhat{\psi}_{a-1t}
    \right\rangle
    \nonumber \\ &=
    2 a^{-\frac{3}{4}} \bigint
    \underbrace{\frac{
