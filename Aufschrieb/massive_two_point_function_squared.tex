...
\label{sec:delta_m2_berechnen}
 ...
 $\left(\rwhat{\Delta}_m * \rwhat{\Delta}_m\right) (-\omega,-k) = \left(\rwhat{\Delta}_m (-\cdot) * \rwhat{\Delta}_m (-\cdot)\right) (\omega,k)$ und wir berechnen also letzteren Ausdruck
...
\begin{figure}
    ...
    \begin{minipage}{0.55\textwidth}
        ...
        wird $\rwhat{\Delta_m}^{*2}(-\cdot)$ und ist singulär genau auf der $2m$-Massenschale}
        \label{fig:delta_2m}
    \end{minipage}\hfill
    \begin{minipage}{0.45\textwidth}
        \centering
        \resizebox{\textwidth}{!}{\input{images/delta_m2_k0.pgf}}
        \caption{Plot von $\left.\rwhat{\Delta_m}^{*2}(-\cdot)\right|_{k=0}$ um das asymptotische Verhalten für $\omega \rightarrow 0$ und $\omega \rightarrow \infty$ zu verdeutlichen}
